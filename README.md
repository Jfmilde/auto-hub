...
RA2 - Realizar tratamento de formulários e aplicar validações customizadas no lado cliente.
 ...
 ID 12 - Aplica expressões regulares (REGEX) para validações customizadas (e-mail, telefone, datas, placa de veículo, etc.)
...
RA4 - Aplicar bibliotecas de funções e componentes em JavaScript para aprimorar a interatividade de páginas web.
 ...
 ID 21 - Integra e configura um plugin jQuery relevante (ex.: jQuery Mask Plugin para placas ou quilometragem).
...
RA5 - Efetuar requisições assíncronas para uma API fake e APIs públicas, permitindo a obtenção e manipulação de dados dinamicamente.
 ...
 ID 24 - Realiza requisições assíncronas para APIs públicas reais (API da Tabela FIPE, ViaCEP etc.), exibindo os dados e tratando erros.
